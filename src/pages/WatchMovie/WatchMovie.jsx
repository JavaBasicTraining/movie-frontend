...
export const WatchMovie = () => {
  ...
  const [lastCommentCreatedDate,] = useState(null);
  ...
  const fetchComment = useCallback(async (page = 0, size = COMMENTS_PER_PAGE) => {
    try {
  ...
  }, [lastCommentCreatedDate, movie.id]);
